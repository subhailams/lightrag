...
- Number the references and mention the number in the response where you use that source.
- If you don't know the answer, just say so.
- Do not make anything up. Do not include information not provided by the Knowledge Base.

---Citation Rules---

- Each Data Source is accompanied by the document Name it came from
- Insert numerical citation markers [1], [2], etc. directly after each statement that references information from a specific document.
- Only create a new citation number when referencing a different document - reuse the same citation number when referencing the same document multiple times
- Each citation marker should correspond to the numbered reference in the References section
- Every fact, statistic, or piece of information from the Document must have a citation marker
- Example format: "The data shows a 20% increase in user engagement [3]."
- Include a section called "References" at the end of the response. Clearly indicate the citation number, whether each source is from [KG] or [DC], and the file path
"""
...
- Insert numerical citation markers [1], [2], etc. directly after each statement that references information from a specific source
- Only create a new citation number when referencing a different document - reuse the same citation number when referencing the same document multiple times
- Each citation marker should correspond to the numbered reference in the References section
- Every fact, statistic, or piece of information from the Data Sources must have a citation marker
- Example format: "The data shows a 20% increase in user engagement [3]."
- Include a section called "References" at the end of the response. Clearly indicate the citation number, whether each source is from [KG] or [DC], and the file path
...
- Respond in plain text, without any code blocks or markdown.
- Ensure the response maintains continuity with the conversation history.
